...
public class Goodslist extends javax.swing.JFrame {
    
    ArrayList<DrinksAndFood> list = new ArrayList();
    int access;
    
    public Goodslist(int x) {
        initComponents();
        access=x;
        ...
        for (int i = 0; i < list.size(); i++) {
             Object[] row = new Object[]{list.get(i).getWeekStock(),Integer.toString(list.get(i).getStock()),list.get(i).getName()};
             d.insertRow(d.getRowCount(), row);
        }
        DATE.setText(DrinksAndFood.getWeekDate());
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "العدد الاصلي", "العدد المتبقي", "اسم المتنج"
            }
        ) {
