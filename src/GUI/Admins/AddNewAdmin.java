...
public class AddNewAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/216490_add_user_icon.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!name.isEmpty() && !pass.isEmpty()) {
            Users newer = new Users(name, pass);
            DataBase.insertUser(newer, 1);
            jButton2.doClick();
        }else{
            JOptionPane.showMessageDialog(this,"برجاء ادخال اسم و كلمة سر","خطاء",JOptionPane.ERROR_MESSAGE);
            Username.grabFocus();
        }      
