...
public class Interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kick-Off Play Station");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel3.setText("Eng: Seif  Mahmoud");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/4991996_game_play_playstation_icon.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        UserLogin window = new UserLogin(Users);
        window.setVisible(true);
        this.hide();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        AdminLogin window = new AdminLogin(1,Admins);
        window.setVisible(true);
        this.hide();
